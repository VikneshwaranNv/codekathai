    ...
    <div className="container-page py-8 sm:py-12">
      ...
      <div className={`mb-8 overflow-hidden rounded-3xl bg-gradient-to-br ${cfg.gradient} p-8 text-white`}>
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={() => onNavigate(level === 'intermediate' ? 'intermediate-story' : 'advanced-story')}
            className="rounded-full bg-golden-400 px-5 py-1.5 text-sm font-bold text-ink-950 transition-all hover:bg-golden-300 shadow-soft"
          >
            Start Story Mission →
          </button>
        </div>
